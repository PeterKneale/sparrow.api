...
import (
	...
	"github.com/simplicate/sparrow.api/scripts/_generated_/client"
	"github.com/simplicate/sparrow.api/scripts/_generated_/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Sparrow API-cli",
		Short: `CLI client for the Sparrow API service`,
	}
